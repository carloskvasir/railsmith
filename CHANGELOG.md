...
All notable changes to the **RailSmith** project will be documented in this file, along with the technical rationale (The "Why") behind them.

---

## [2026-03-15] - The Ruby 4.0 "Vanguard" Release
...
### 🛠️ DX & CLI Fixes
- **Claude Code Integration**: verified as a native AI coding assistant.
- **Bitwarden CLI Permission Fixes**: Implemented correct home directory ownership (`/home/vscode/.config`).
  - **The "Why"**: Prevents `EACCES` errors when running the CLI as a non-root user in DevContainers, ensuring the "headless" workflow is seamless.
